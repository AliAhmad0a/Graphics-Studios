...
const OurWorkVideos = () => {
  return (
    <section id="our-work-videos" className="section" style={{ position: 'relative', overflow: 'hidden' }}>
      ...
      >
        <div className="section-title">Our Work <span className="gradient-text">Videos</span></div>
        <p className="section-subtitle">
          Dynamic visual stories crafted to captivate and convert audiences.
        </p>
      </motion.div>
